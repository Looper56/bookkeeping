...
type RegisterMiniProgramParam struct {
	...
	CodeType           string `json:"code_type"`            // 企业代码类型 1：统一社会信用代码（18 位） 2：组织机构代码（9 位 bookkeeping/pkg/wechatgoxxx-x） 3：营业执照注册号(15 位)
...
// reference:
// developers.weixin.qq.com/doc/oplatform/Third-party_Platforms/Mini_Programs/Fast_Registration_Interface_document.html
func (component *Component) RegisterMiniProgram(param *RegisterMiniProgramParam) error {
	...
	url := api.FastregisterweappUri(componentAK)
