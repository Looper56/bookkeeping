...
func (cube *DataCube) fetchData(params ParamsPublisher) (response []byte, err error) {
	...
	uri := fmt.Sprintf("%s?%s", api.PublisherUri(), v.Encode())
...
func (cube *DataCube) GetPublisherAdPosGeneral(startDate, endDate string, page, pageSize int,
	adSlot AdSlot) (resPublisherAdPos ResPublisherAdPos, err error) {
	...
	if resPublisherAdPos.BaseResp.Ret != 0 {
		err = fmt.Errorf("GetPublisherAdPosGeneral Error , errcode=%d , errmsg=%s",
			resPublisherAdPos.BaseResp.Ret, resPublisherAdPos.BaseResp.ErrMsg)
		return
	}
	return
}
...
func (cube *DataCube) GetPublisherCpsGeneral(startDate, endDate string,
	page, pageSize int) (resPublisherCps ResPublisherCps, err error) {
	params := ParamsPublisher{
	...
	if resPublisherCps.BaseResp.Ret != 0 {
		err = fmt.Errorf("GetPublisherCpsGeneral Error , errcode=%d , errmsg=%s",
			resPublisherCps.BaseResp.Ret, resPublisherCps.BaseResp.ErrMsg)
		return
	}
	return
}
...
func (cube *DataCube) GetPublisherSettlement(startDate, endDate string,
	page, pageSize int) (resPublisherSettlement ResPublisherSettlement, err error) {
	params := ParamsPublisher{
	...
	if resPublisherSettlement.BaseResp.Ret != 0 {
		err = fmt.Errorf("GetPublisherSettlement Error , errcode=%d , errmsg=%s",
			resPublisherSettlement.BaseResp.Ret, resPublisherSettlement.BaseResp.ErrMsg)
		return
	}
	return
}
