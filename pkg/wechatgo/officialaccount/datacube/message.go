...
func (cube *DataCube) GetUpstreamMsg(s string, e string) (resUpstreamMsg ResUpstreamMsg, err error) {
	...
	uri := api.GetUpstreamMsgUri(accessToken)
	reqDate := &reqDate{
		BeginDate: s,
		EndDate:   e,
	}
...
func (cube *DataCube) GetUpstreamMsgHour(s string, e string) (resUpstreamMsgHour ResUpstreamMsgHour, err error) {
	...
	uri := api.GetUpstreamMsgHourUri(accessToken)
	reqDate := &reqDate{
		BeginDate: s,
		EndDate:   e,
	}
...
func (cube *DataCube) GetUpstreamMsgWeek(s string, e string) (resUpstreamMsgWeek ResUpstreamMsgWeek, err error) {
	...
	uri := api.GetUpstreamMsgWeekUri(accessToken)
	reqDate := &reqDate{
		BeginDate: s,
		EndDate:   e,
	}
...
func (cube *DataCube) GetUpstreamMsgMonth(s string, e string) (resUpstreamMsgMonth ResUpstreamMsgMonth, err error) {
	...
	uri := api.GetUpstreamMsgMonthUri(accessToken)
	reqDate := &reqDate{
		BeginDate: s,
		EndDate:   e,
	}
...
func (cube *DataCube) GetUpstreamMsgDist(s string, e string) (resUpstreamMsgDist ResUpstreamMsgDist, err error) {
	...
	uri := api.GetUpstreamMsgDistUri(accessToken)
	reqDate := &reqDate{
		BeginDate: s,
		EndDate:   e,
	}
...
func (cube *DataCube) GetUpstreamMsgDistWeek(s string, e string) (resUpstreamMsgDistWeek ResUpstreamMsgDistWeek,
	err error) {
	accessToken, err := cube.GetAccessToken()
	if err != nil {
		return
	...
	uri := api.GetUpstreamMsgDistWeekUri(accessToken)
	reqDate := &reqDate{
		BeginDate: s,
		EndDate:   e,
	}
...
func (cube *DataCube) GetUpstreamMsgDistMonth(s string, e string) (resUpstreamMsgDistMonth ResUpstreamMsgDistMonth,
	err error) {
	accessToken, err := cube.GetAccessToken()
	if err != nil {
		return
	...
	uri := api.GetUpstreamMsgDistMonthUri(accessToken)
	reqDate := &reqDate{
		BeginDate: s,
		EndDate:   e,
	}
