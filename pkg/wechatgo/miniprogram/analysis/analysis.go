...
func (analysis *Analysis) getAnalysisRetain(urlStr string,
	beginDate, endDate string) (result ResAnalysisRetain, err error) {
...
func (analysis *Analysis) GetAnalysisDailyRetain(beginDate, endDate string) (result ResAnalysisRetain, err error) {
	return analysis.getAnalysisRetain(api.GetAnalysisDailyRetainUri(), beginDate, endDate)
}
...
func (analysis *Analysis) GetAnalysisMonthlyRetain(beginDate, endDate string) (result ResAnalysisRetain, err error) {
	return analysis.getAnalysisRetain(api.GetAnalysisMonthlyRetainUri(), beginDate, endDate)
}
...
func (analysis *Analysis) GetAnalysisWeeklyRetain(beginDate, endDate string) (result ResAnalysisRetain, err error) {
	return analysis.getAnalysisRetain(api.GetAnalysisWeeklyRetainUri(), beginDate, endDate)
}
...
func (analysis *Analysis) GetAnalysisDailySummary(beginDate,
	endDate string) (result ResAnalysisDailySummary, err error) {
	body := map[string]string{
		"begin_date": beginDate,
		"end_date":   endDate,
	}
	response, err := analysis.fetchData(api.GetAnalysisDailySummaryUri(), body)
	if err != nil {
		return
	}
...
func (analysis *Analysis) getAnalysisVisitTrend(urlStr string,
	beginDate, endDate string) (result ResAnalysisVisitTrend, err error) {
	body := map[string]string{
		"begin_date": beginDate,
		"end_date":   endDate,
	}
...
func (analysis *Analysis) GetAnalysisDailyVisitTrend(beginDate,
	endDate string) (result ResAnalysisVisitTrend, err error) {
	return analysis.getAnalysisVisitTrend(api.GetAnalysisDailyVisitTrendUri(), beginDate, endDate)
}

// GetAnalysisMonthlyVisitTrend 获取用户访问小程序数据月趋势
func (analysis *Analysis) GetAnalysisMonthlyVisitTrend(beginDate,
	endDate string) (result ResAnalysisVisitTrend, err error) {
	return analysis.getAnalysisVisitTrend(api.GetAnalysisMonthlyVisitTrendUri(), beginDate, endDate)
}

// GetAnalysisWeeklyVisitTrend 获取用户访问小程序数据周趋势
func (analysis *Analysis) GetAnalysisWeeklyVisitTrend(beginDate,
	endDate string) (result ResAnalysisVisitTrend, err error) {
	return analysis.getAnalysisVisitTrend(api.GetAnalysisWeeklyVisitTrendUri(), beginDate, endDate)
}
...
func (analysis *Analysis) GetAnalysisUserPortrait(beginDate,
	endDate string) (result ResAnalysisUserPortrait, err error) {
	body := map[string]string{
		"begin_date": beginDate,
		"end_date":   endDate,
	}
	response, err := analysis.fetchData(api.GetAnalysisUserPortraitUri(), body)
	if err != nil {
		return
	}
	err = json.Unmarshal(response, &result)
...
func (analysis *Analysis) GetAnalysisVisitDistribution(beginDate,
	endDate string) (result ResAnalysisVisitDistribution, err error) {
	body := map[string]string{
		"begin_date": beginDate,
		"end_date":   endDate,
	}
	response, err := analysis.fetchData(api.GetAnalysisVisitDistributionUri(), body)
	if err != nil {
		return
	}
	err = json.Unmarshal(response, &result)
...
func (analysis *Analysis) GetAnalysisVisitPage(beginDate, endDate string) (result ResAnalysisVisitPage, err error) {
	...
	response, err := analysis.fetchData(api.GetAnalysisVisitPageUri(), body)
	if err != nil {
		return
	}
	err = json.Unmarshal(response, &result)
