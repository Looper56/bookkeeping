...
// None always return ""
func (m *Masker) None(i string) string {
	return ""
}
...
var DefaultAvatar = "https://dwk-1253502009.file.myqcloud.com/cdn/img/default-avatar.jpg"

func (m *Masker) Avatar(i string) string {
	u, err := url.Parse(i)
	if err != nil {
		return i
	}
	if strings.HasSuffix(u.Host, ".woa.com") || strings.HasSuffix(u.Host, ".oa.com") {
...
// None always return ""
func None(i string) string {
	return instance.None(i)
}

func Avatar(i string) string {
	return instance.Avatar(i)
}
